...
public class AnuncioResponseDTO {
    ...
    public AnuncioResponseDTO(Long id, String titulo, BigDecimal preco, String condicao, String completude, String status, String localizacao, String urlFotoPrincipal, PlataformaResumoDTO plataforma, CategoriaResumoDTO categoria) {
        this.id = id;
        this.titulo = titulo;
        this.preco = preco;
